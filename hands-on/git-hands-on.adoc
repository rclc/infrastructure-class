...
If you accidentally added a file to the staging area, you can remove the file using the `git rm --cached <filename>` command. 
...
Or, using the `git reset HEAD <filename>` command.
...
.Example:
----
$ git clone https://github.com/rclc/infrastructure-class.git
----
...
$ git pull https://github.com/rclc/infrastructure-class.git
